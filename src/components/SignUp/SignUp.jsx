...
//         name: '',  // Use firstName for the first name
//         surname: '',    // Use surname for the last name
//         email: '',
//         password: ''
//     });
...
//         textMsg = 'All Fields must be filled';
//         textColor = 'red'; 
//       }
//       else if (!email.includes('@')) {
//         textMsg = 'Email is invalid';
//         textColor = 'red';       
//       }
//       else if(password.length < 6){
//         textMsg = 'Password Should be more than length 6';
//         textColor = 'red';
//      //  setSuccessMessage('No Error Found Congrats the user is logged in.');
//      }
